...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const now = new Date();
  const staticRoutes = ['', '/games', '/standings', '/rankings', '/teams', '/players', '/controls', '/stats', '/trades', '/tournaments', '/news', '/blacklist', '/accolades', '/staff', '/links', '/search', '/playoffs', '/partners', '/privacy', '/terms'];
