...
export function AuthButton() {
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <Link href="/account" className="grid h-10 w-10 place-items-center rounded-full border border-[var(--line)] text-[var(--ink-soft)] transition hover:text-[var(--ink)]" title="My account" aria-label="My account">
